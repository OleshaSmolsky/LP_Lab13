...
#define ERROR_MAXSIZE_MESSAGE 200										//максимальная длина сообщения об ошибках
...
namespace Error
{
	struct ERROR	// тип исключение для throw ERROR_THROW |ERROR_THROW_IN и catch(ERROR)
	{
		int id;									//код ошибки
